...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.picture'
        db.add_column('restaurants_restaurant', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Food.picture'
        db.add_column('restaurants_food', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.picture'
        db.delete_column('restaurants_restaurant', 'picture')

        # Deleting field 'Food.picture'
        db.delete_column('restaurants_food', 'picture')
