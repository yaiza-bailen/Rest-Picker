...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.gmap_url'
        db.add_column('restaurants_restaurant', 'gmap_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.gmap_url'
        db.delete_column('restaurants_restaurant', 'gmap_url')
    ...
    models = {
        ...
        'restaurants.restaurant': {
            ...
            'gmap_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
